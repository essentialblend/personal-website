...
Finding exact answers aside, even precisely _framing_ some of these questions appropriately requires some non-trivial machinery. I remember asking some of these questions years ago and could only understand some of it in the recent past. We covered considerable ground in this first article, and it's best to spend some time understanding these concepts. The key takeaway from Part I is that a _recursive definition_ solves a problem by invoking itself on smaller inputs.
